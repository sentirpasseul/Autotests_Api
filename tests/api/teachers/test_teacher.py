...
class TestTeacher:
    ...
    def test_create_teacher(self, university_api_utils_anonym, teacher_helper, generate_random_teacher):
        response = teacher_helper.post_teacher(generate_random_teacher.model_dump())
